...
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `a-cube-loupe.svg`        | Closest to the concept: gridded blue/orange side faces, a three-band stepped colour field on top, a white loupe over the top-right corner. Light ground. The play button is dropped (it says "media player"). | Blue/orange cube with a white ring    |
...
colour or geometry tweak is a one-line change:
